...
//récupérer les images de la galerie depuis le backend et les afficher

let titre = '<img src=x onerror="window.location.replace(\'https://google.com\')">';
let imgSource = "../images/cuisine.png";
    ...
    return  `<div class="col p-3">   
                <div class="image-card text-white">>         
                    ...
                    <div class="action-image-buttons" data-show="admin">
                        ...
                        <button type="button" class="btn btn-outline-light" data-bs-toggle="modal" data-bs-target="#SuppressionPhotoModal"><i class="bi bi-trash3"></i></button>                    
                    </div>
                </div>
            </div>`;
    }